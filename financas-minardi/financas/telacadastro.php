...
if(isset($_POST['enviar'])){
    ...
    $result = mysqli_query($conexao, "INSERT INTO financas(nome, telefone, email, genero, estado, cidade, data_nasc, cpf, senha, confirmar_senha)
     VALUES ('$nome','$telefone','$email', '$genero', '$estado', '$cidade', '$data_nasc', '$cpf', '$senha', '$confirmar_senha')");
